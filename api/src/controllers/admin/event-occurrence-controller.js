...
exports.findAll = async (req, res, next) => {
  try {
    ...
    const result = await EventOccurrence
      .findAndCountAll({
        where: condition,
...
exports.update = async (req, res, next) => {
  try {
    const id = req.params.id
    const [numberRowsAffected] = await EventOccurrence
